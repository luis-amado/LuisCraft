...
Texture::Texture(const unsigned char* bytes, unsigned int width, unsigned int height) {
...
void Texture::generate(const char* filepath, unsigned int mipmapLevels, GLuint filter) {
